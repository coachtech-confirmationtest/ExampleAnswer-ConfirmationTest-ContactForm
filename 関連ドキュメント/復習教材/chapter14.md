...
これで、確認テストで求められる全ての基本機能と応用機能の実装が完了しました。次のチャプターでは、応用編として**公開APIの提供**に挑戦します。これまでBlade（SSR）で構築してきたアプリケーションに、JSON形式でデータを返すAPIエンドポイントを追加し、API Resources、APIコントローラー、APIルーティングの書き方を学んでいきます。
